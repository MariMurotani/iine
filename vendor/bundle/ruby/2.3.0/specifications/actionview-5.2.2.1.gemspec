# -*- encoding: utf-8 -*-
# stub: actionview 5.2.2.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/rails/rails/blob/v5.2.2.1/actionview/CHANGELOG.md", "source_code_uri" => "https://github.com/rails/rails/tree/v5.2.2.1/actionview" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<actionpack>.freeze, ["= 5.2.2.1"])
      s.add_development_dependency(%q<activemodel>.freeze, ["= 5.2.2.1"])
    else
